...
const Recent = ({ userPosts = [] }) => {
  const navigate = useNavigate()
  const allPosts = [...userPosts, ...recentPosts]
  ...
  return (
    <section className="section recent">
      <div className="container">
        <h2 className="h2 section-title">Recent Posts</h2>
        <p className="section-subtitle">
          Stay updated with our <strong className="strong">latest articles</strong>
        </p>
