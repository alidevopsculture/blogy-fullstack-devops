import { featuredPosts, topAuthors } from '../data/posts'
      ...
      <div className="container">
        <div className="featured-header">
          <div className="featured-title-section">
            <h2 className="h2 section-title">Featured Stories</h2>
          ...
          <div className="top-authors">
            <div className="top-authors-avatars">
              {topAuthors.map(author => (
                <button 
                  key={author.id}
                  className="avatar large"
                  onClick={() => handleAuthorClick(author.id)}
                  title={`${author.name} - ${author.postsCount} posts`}
                >
                  <img 
                    src={author.avatar} 
                    alt={author.name}
            ...
            <span className="top-authors-text">Meet our top authors</span>
          </div>
        </div>
